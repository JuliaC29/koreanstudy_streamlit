...
st.markdown("<h1 class='title' style='text-align: center; margin-bottom: 0px;'>한국어 단어와 문법</h1>", unsafe_allow_html=True)
st.markdown("<div style='text-align: center; margin-top: 0px;'><a href='https://mykoreanstudy.netlify.app/'>Visit My Korean Study Website</a></div>", unsafe_allow_html=True)
